<template>
  <div class="absolute inset-0 flex items-center justify-center" style="z-index: 50">
    ...
    >
      ...
      <!-- Content -->
      <div class="px-6 py-5 overflow-y-auto no-scrollbar flex-1" style="max-height: calc(100vh - 180px)">
          ...
          <div class="flex gap-5">
            ...
            <div class="flex flex-col items-center gap-2">
              ...
              <button
                ...
                style="font-size: 10px; color: var(--vn-muted)"
            ...
            <div class="flex-1">
              ...
              <div class="flex items-center justify-between py-2">
                <div class="flex items-center gap-2">
                  <i
                    :class="store.userCharacter.showSprite ? 'fa-solid fa-eye' : 'fa-solid fa-eye-slash'"
                    :style="{
                      fontSize: '0.8rem',
                      color: store.userCharacter.showSprite ? 'var(--rust)' : 'var(--vn-muted)',
                    }"
                  />
              ...
              <p
                ...
                style="font-size: 9px; color: rgba(139, 125, 107, 0.6); margin-top: 4px"
              >
                请先上传头像才能开启立绘显示
              </p>
            </div>
        ...
        <div class="flex flex-col gap-3">
          ...
          >
            <div class="p-3 flex items-center gap-3">
              <div
                class="w-12 h-12 border flex items-center justify-center shrink-0 overflow-hidden"
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2">
                  <span
                    ...
                    :style="{ color: char.unlocked ? 'rgba(212,197,160,0.9)' : 'var(--vn-muted)' }"
                  >
                  ...
                  <span
                    v-if="!char.unlocked"
                    class="border px-1"
                    style="font-size: 8px; color: var(--vn-muted); border-color: rgba(90, 79, 64, 0.3)"
                    >未解锁</span
                  >
                </div>
                <p
                  ...
                  class="truncate"
                  style="font-size: 11px; color: var(--vn-muted); margin-top: 2px"
                >
                  {{ char.description }}
                </p>
              </div>
